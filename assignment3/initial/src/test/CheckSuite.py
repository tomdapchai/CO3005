...
class CheckSuite(unittest.TestCase):
    ...
    #     }
    #     """
    #     expect = "Undeclared Identifier: arr1\n"
    ...
    def test_506(self):
        ...
        """
        expect = "Type Mismatch: Assign(ArrayCell(Id(arr),[IntLiteral(0)]),ArrayLiteral([IntLiteral(3)],IntType,[IntLiteral(1),IntLiteral(2)]))\n"
    ...
    def test_507(self):
        ...
        """
        expect = "Type Mismatch: Assign(ArrayCell(Id(arr),[IntLiteral(1)]),ArrayLiteral([IntLiteral(3)],IntType,[IntLiteral(1),IntLiteral(2),IntLiteral(3)]))\n"
